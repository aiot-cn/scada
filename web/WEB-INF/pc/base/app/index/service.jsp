                        ...
                        <div class="service-sidebar">
                            <div class="widget category">
                                ...
                                <div class="category-list">
                                    <a href="#"><i class="far fa-angle-double-right"></i>Machine Learning</a>
                                    <a href="#"><i class="far fa-angle-double-right"></i>Data Mining</a>
                                    <a href="#"><i class="far fa-angle-double-right"></i>Robotic Automation</a>
                                    <a href="#"><i class="far fa-angle-double-right"></i>Deep Learning</a>
                                    <a href="#"><i class="far fa-angle-double-right"></i>Predictive Analytic</a>
                                    <a href="#"><i class="far fa-angle-double-right"></i>Security & Surveillance</a>
                                    <a href="#"><i class="far fa-angle-double-right"></i>Statistic Modeling</a>
                                </div>
                            </div>
                    ...
                    <div class="col-xl-8 col-lg-8">
                        <div class="service-details">
                            <div class="service-details-img mb-30">
                                <img src="${res}/app/index/image/service01.jpg" alt="thumb">
                            </div>
                            <div class="service-details">
                                <h3 class="mb-30">Machine Learning</h3>
                                <p class="mb-20">
