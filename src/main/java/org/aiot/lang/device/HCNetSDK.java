...
//9000 IPC接入
    ...
    /**********************云台控制命令 begin*************************/
    public static final int NET_DVR_GET_FOCUSMODECFG = 3305;//云台获取PTZ范围
...
// ivms进入检测区域NET_IVMS_ENTER_REGION
 ...
 // 热成像测温
  ...
  //dwType
    public static final int NET_SDK_CALLBACK_TYPE_STATUS = 0;//状态
    public static final int NET_SDK_CALLBACK_TYPE_PROGRESS = 1;//进度
    public static final int NET_SDK_CALLBACK_TYPE_DATA  = 2;//数据
...
//通道图象结构
  ...
  public static class NET_DVR_MOTION_V30 extends Structure {//移动侦测(子结构)(9000扩展)
		...
		@Override
		protected List<String> getFieldOrder() {
			return Arrays.asList("byMotionScope","byMotionSensitive","byEnableHandleMotion","byPrecision","reservedData","struMotionHandleType","struAlarmTime","byRelRecordChan");
		}
    }
...
public static class NET_DVR_ALARMINFO_V30 extends Structure {//上传报警信息(9000扩展)
    ...
    public static class NET_DVR_ACS_ALARM_INFO extends Structure {
        ...
        public int dwMajor;//报警主类型
        public int dwMinor;//报警次类型
        ...
        public NET_DVR_ACS_EVENT_INFO struAcsEventInfo;//报警信息详细参数
        public int dwPicDataLen;//图片数据大小，不为0是表示后面带数据
        public String pPicData;//图片数据缓冲区
        ...
        public String pAcsEventInfoExtendV20;
        public byte[] byRes=new byte[4];

        @Override
        protected List getFieldOrder() {
            return Arrays.asList("dwSize", "dwMajor", "dwMinor", "struTime", "sNetUser",
                    "struRemoteHostAddr","struAcsEventInfo","dwPicDataLen","pPicData","wInductiveEventType",
                    "byPicTransType","byRes1","dwIOTChannelNo","pAcsEventInfoExtend","byAcsEventInfoExtend",
                    "byTimeType","byRes2","byAcsEventInfoExtendV20","pAcsEventInfoExtendV20","byRes");
        }
    }
    //门禁主机报警事件细节结构体
    public static class NET_DVR_ACS_EVENT_INFO  extends Structure {
        ...
        public byte byCardType;//卡类型：1- 普通卡，2- 残疾人卡，3- 黑名单卡，4- 巡更卡，5- 胁迫卡，6- 超级卡，7- 来宾卡，8- 解除卡，为0表示无效
        public byte byWhiteListNo;//白名单单号，取值范围：1~8，0表示无效
        public byte byReportChannel;//报告上传通道：1- 布防上传，2- 中心组1上传，3- 中心组2上传，0表示无效

        public byte byCardReaderKind;//读卡器类型：0- 无效，1- IC读卡器，2- 身份证读卡器，3- 二维码读卡器，4- 指纹头
        public int dwCardReaderNo;//读卡器编号，为0表示无效
        public int dwDoorNo;//门编号（或者梯控的楼层编号），为0表示无效（当接的设备为人员通道设备时，门1为进方向，门2为出方向）
        public int dwVerifyNo;//多重卡认证序号，为0表示无效
        public int dwAlarmInNo;//报警输入号，为0表示无效

        public int dwAlarmOutNo;//报警输出号，为0表示无效
        public int dwCaseSensorNo;//事件触发器编号
        public int dwRs485No;//RS485通道号，为0表示无效
        public int dwMultiCardGroupNo;//群组编号
        public short wAccessChannel;//人员通道号

        public byte byDeviceNo;//设备编号，为0表示无效
        public byte byDistractControlNo;//分控器编号，为0表示无效
        public int dwEmployeeNo;//工号，为0无效
        public short wLocalControllerID;//就地控制器编号，0-门禁主机，1-255代表就地控制器
        ...
        protected List getFieldOrder() {
            return Arrays.asList("dwSize","byCardNo","byCardType","byWhiteListNo","byReportChannel",
                    "byCardReaderKind","dwCardReaderNo","dwDoorNo","dwVerifyNo","dwAlarmInNo",
                    "dwAlarmOutNo","dwCaseSensorNo","dwRs485No","dwMultiCardGroupNo","wAccessChannel",
                    "byDeviceNo","byDistractControlNo","dwEmployeeNo","wLocalControllerID","byInternetAccess",
                    "byType","byMACAddr","bySwipeCardType","byMask","dwSerialNo",
                    "byChannelControllerID","byChannelControllerLampID","byChannelControllerIRAdaptorID","byChannelControllerIREmitterID","byRes");
        }
    }
...
public static class NET_DVR_IPSERVER_STREAM extends Structure {
	...
	@Override
	protected List getFieldOrder() {
		return Arrays.asList("byEnable","byRes","struIPServer","wPort","wDvrNameLen","byDVRName","wDVRSerialLen","byRes1","byDVRSerialNumber","byUserName","byPassWord","byChannel","byRes2");
	}
}
...
public static class NET_DVR_DEV_CHAN_INFO extends Structure {
	...
	@Override
	protected List getFieldOrder(){
		return Arrays.asList("struIP","wDVRPort","byChannel","byTransProtocol","byTransMode","byFactoryType","byDeviceType","byDispChan","bySubDispChan","byResolution","byRes","byDomain","sUserName","sPassword");
	}
}
...
public static class NET_DVR_DDNS_STREAM_CFG extends Structure {
    ...
    @Override
    protected List getFieldOrder() {
        return Arrays.asList("byEnable","byRes1","struStreamServer","wStreamServerPort","byStreamServerTransmitType","byRes2","struIPServer","wIPServerPort","byRes3",
        "sDVRName","wDVRNameLen","wDVRSerialLen","sDVRSerialNumber","sUserName","sPassWord","wDVRPort","byRes4","byChannel","byTransProtocol","byTransMode","byFactoryType");
    }
}
...
public static class NET_DVR_HKDDNS_STREAM extends Structure {
    ...
    @Override
    protected List getFieldOrder() {
        return Arrays.asList("byEnable","byRes","byDDNSDomain","wPort","wAliasLen","byAlias","wDVRSerialLen","byRes1","byDVRSerialNumber","byUserName","byPassWord","byChannel","byRes2");
    }
}
...
public static class NET_DVR_IPCHANINFO_V40 extends Structure {
    ...
    @Override
    protected List getFieldOrder() {
        return Arrays.asList("byEnable","byRes1","wIPID","dwChannel","byTransProtocol","byTransMode","byFactoryType","byRes");
    }
}
...
public static class NET_DVR_GET_STREAM_UNION extends Union {
    ...
    /*@Override
    protected List getFieldOrder() {
        return Arrays.asList("struChanInfo","struIPServerStream","struPUStream","struDDNSStream","struStreamUrl","struHkDDNSStream","struIPChan");
    }*/
}
...
public static class NET_DVR_STREAM_MODE extends Structure {
    /**
     * 取流方式：<br>
            0- 直接从设备取流，对应联合体中结构NET_DVR_IPCHANINFO；<br>
            1- 从流媒体取流，对应联合体中结构NET_DVR_IPSERVER_STREAM；<br>
            2- 通过IPServer获得IP地址后取流，对应联合体中结构NET_DVR_PU_STREAM_CFG；<br>
            3- 通过IPServer找到设备，再通过流媒体取设备的流，对应联合体中结构NET_DVR_DDNS_STREAM_CFG；<br>
            4- 通过流媒体由URL去取流，对应联合体中结构NET_DVR_PU_STREAM_URL；<br>
            5- 通过hiDDNS域名连接设备然后从设备取流，对应联合体中结构NET_DVR_HKDDNS_STREAM；<br>
...
public static class NET_DVR_IPPARACFG_V40 extends Structure {
	...
	@Override
	protected List getFieldOrder() {
		return Arrays.asList("dwSize","dwGroupNum","dwAChanNum","dwDChanNum","dwStartDChan","byAnalogChanEnable","struIPDevInfo","struStreamMode","byRes2");
	}
}
...
public static class NET_DVR_ALARMER extends Structure{
   ...
   public   byte[] byRes2 = new byte[11];
    ...
    @Override
    protected List getFieldOrder() {
        return Arrays.asList("byUserIDValid","bySerialValid","byVersionValid","byDeviceNameValid","byMacAddrValid","byLinkPortValid",
        "byDeviceIPValid","bySocketIPValid","lUserID","sSerialNumber","dwDeviceVersion","sDeviceName","byMacAddr",
        "wLinkPort","sDeviceIP","sSocketIP","byIpProtocol","byRes2");
    }

    @Override
    public String toString(){
        return String.format("IP:%s NAME:%s",new String(sDeviceIP),new String(sDeviceName));
    }
}
...
public static class NET_DVR_VOD_PARA extends Structure
{
 ...
 public static class NET_DVR_FILECOND extends Structure //录象文件查找条件结构
    ...
    /**
     * 云台图像区域位置信息。
     * 该结构体中的坐标值与当前预览显示框的大小有关，现假设预览显示框为352*288，我们规定原点为预览显示框【左上角】的顶点，前四个参数计算方法如下：
	...
	public int xTop;     //方框 起始点 x坐标
	public int yTop;     //方框 起始点 y坐标
	public int xBottom;  //方框 结束点 x坐标
	public int yBottom;  //方框 结束点 y坐标
...
public static class  NET_PTZ_INFO extends Structure{
    public float  fPan;//P参数（水平参数），精确到小数点后3位，范围：0 – 36.000
    public float  fTilt;//T参数（垂直参数），精确到小数点后3位，范围：-90.000 – 270.000
    public float  fZoom;//Z参数（变倍参数），精确到小数点后3位，范围：0-100000
    ...
    public static class  NET_DVR_PTZABSOLUTEEX_CFG extends Structure{
        public int          dwSize;//结构体大小
        public NET_PTZ_INFO struPTZCtrl;//设备PTZF信息
        public int          dwFocalLen;//焦距范围：0-100000，单位：mm
        public float        fHorizontalSpeed;//水平转动速度：0.01-1000.00，单位：度/S
        public float        fVerticalSpeed;//垂直转动速度：0.01-1000.00，单位：度/S
        public byte         byZoomType;//镜头变倍配置类型： 0~ absoluteZoom，1~ focalLen。absoluteZoom：通过变倍参数进行配置，选择为该类型时struPTZCtrl中的fZoom参数生效。focalLen：通过焦距参数进行配置，选择为该类型时，dwFocalLen参数生效。
        public byte[]       byRes = new byte[123];


        @Override
        protected List<String> getFieldOrder() {
            return Arrays.asList("dwSize", "struPTZCtrl", "dwFocalLen", "fHorizontalSpeed","fVerticalSpeed","byZoomType","byRes");
        }
    }
...
public static class NET_DVR_FOCUSMODE_CFG extends Structure{
	...
	public  byte   byAutoFocusMode;//自动聚焦模式：0-关，1-模式A，2-模式B，3-模式AB，4-模式C
	public  short  wMinFocusDistance;//最小聚焦距离，单位CM：0-自动，0xffff-无穷远
	public  byte   byZoomSpeedLevel;//变倍速度，为实际取值，取值范围：1~3
	public  byte   byFocusSpeedLevel;//聚焦速度，为实际取值，取值范围：1~3
	public  byte   byOpticalZoom;//光学变倍，取值范围：0~255
	public  byte   byDigtitalZoom;//数字变倍，取值范围：0~255
	public  float  fOpticalZoomLevel;//光学变倍(倍率值)，取值范围：[1,32]，最小间隔0.5 ，内部设备交互的时候*1000
	public  int    dwFocusPos;//focus值（聚焦值），取值范围：[0x1000,0xC000]，这个值是sony坐标值，使用这个值是为了对外统一，保证不同的镜头对外focus值都转换在这个范围内 (手动聚焦模式下下应用)
...
@Override
	protected List<String> getFieldOrder() {
	   return Arrays.asList("dwSize", "byFocusMode", "byAutoFocusMode", "wMinFocusDistance","byZoomSpeedLevel","byFocusSpeedLevel","byOpticalZoom",
               "byDigtitalZoom","fOpticalZoomLevel","dwFocusPos","byFocusDefinitionDisplay","byFocusSensitivity","byRes1","dwRelativeFocusPos","byRes");
	}
}
...
public static class NET_DVR_REALTIME_THERMOMETRY_COND extends Structure {
    ...
    public byte[] byRes= new byte [60];//上传间隔（仅温差模式支持），取值范围：1-3600 秒，填0则默认3600S上传一次
    @Override
	protected List getFieldOrder() {
		return Arrays.asList("dwSize","dwChan","byRuleID","byMode","wInterval","byRes");
	}
...
public static class NET_DVR_THERMOMETRY_UPLOAD extends Structure {
    ...
    public NET_DVR_POINT_THERM_CFG  struPointThermCfg;//点测温实时信息结构体
    public NET_DVR_LINEPOLYGON_THERM_CFG  struLinePolygonThermCfg;//框/线测温实时信息结构体
    /**
     * 0- 摄氏度（℃），1- 华氏度（℉），2- 开尔文(K)
     */
    ...
    public byte byRes1;
    /**
     * 是否支持特殊点测温，按位表示不同类型的特殊点：
     * bit0-中心点测温：0-不支持，1-支持；
     * bit1-最高点测温：0-不支持，1-支持；
     * bit2-最低点测温：0-不支持，1-支持
     */
    public byte bySpecialPointThermType;
    public float fCenterPointTemperature;//中心点温度（由bySpecialPointThermType取值判断是否支持中心点），精确到小数点后一位
	...
	@Override
	protected List getFieldOrder() {
		return Arrays.asList("dwSize","dwRelativeTime","dwAbsTime","szRuleName","byRuleID","byRuleCalibType","wPresetNo","struPointThermCfg","struLinePolygonThermCfg",
        "byThermometryUnit","byDataType","byRes1","bySpecialPointThermType","fCenterPointTemperature","fHighestPointTemperature","fLowestPointTemperature",
        "struHighestPoint","struLowestPoint","byIsFreezedata",
        "byRes");
	}
...
//设置设备的配置信息
public static class NET_DVR_SetSTDConfig extends Structure {
	public NativeLong lUserID;
	public int dwCommand;
	public NET_DVR_THERMOMETRY_BASICPARAM  lpConfigParam;
	@Override
	protected List getFieldOrder() {
		return Arrays.asList("lUserID","dwCommand","lpConfigParam");
	}
}
...
public static class NET_DVR_THERMOMETRY_BASICPARAM extends Structure {
		...
		@Override
		protected List getFieldOrder() {
			return Arrays.asList("dwSize","byEnabled","byStreamOverlay","byPictureOverlay","byThermometryRange",
	"byThermometryUnit","byThermometryCurve","byFireImageModea","byShowTempStripEnable","fEmissivity",
	"byDistanceUnit","byEnviroHumidity","byRes2","struTempColor","iEnviroTemperature",
	"iCorrectionVolume","bySpecialPointThermType","byReflectiveEnabled","wDistance","fReflectiveTemperature",
	"fAlert","fAlarm","fThermalOpticalTransmittance","fExternalOpticsWindowCorrection","byDisplayMaxTemperatureEnabled",
	"byDisplayMinTemperatureEnabled","byDisplayAverageTemperatureEnabled","byThermometryInfoDisplayposition","dwAlertFilteringTime","dwAlarmFilteringTime",
	"byemissivityMode","bydisplayTemperatureInOpticalChannelEnabled","byRes");
		}
}
...
//手动测温规则配置结构体[NET_DVR_SetSTDConfig配置]

public static class NET_SDK_MANUAL_THERMOMETRY extends Structure {
	public int	dwSize;
	public int	dwChannel;//通道号
	public int	dwRelativeTime;//相对时标（只读）
	public int	dwAbsTime;//绝对时标（只读）
	...
	public NET_SDK_MANUALTHERM_RULE	struRuleInfo;//手动测温规则
	public byte[]	byRes= new byte[512];//保留
	@Override
	protected List getFieldOrder() {
		return Arrays.asList("dwSize","dwChannel","dwRelativeTime","dwAbsTime","byThermometryUnit","byDataType","byRes1","struRuleInfo","byRes");
	}
}

//手动测温规则结构体
public static class NET_SDK_MANUALTHERM_RULE extends Structure {
	public  byte	byRuleID;//规则ID，0-表示无效，从1开始
    public  byte    byEnable;//是否启用：0-否，1-是
    public  byte[]	byRes1 = new byte[2];
	public  char[]	szRuleName = new char[NAME_LEN];//规则名称
    public  byte	byRuleCalibType;//规则标定类型：0-点，1-框，2-线
    public  byte[]	byRes2= new byte[3];
	public  NET_SDK_POINT_THERMOMETRY	struPointTherm;//点测温，当标定类型为0-点时生效
    public  NET_SDK_REGION_THERMOMETRY	struRegionTherm;//区域测温，当标定类型为1-框、2-线时生效
    public  byte[]	byRes = new byte[512];
	@Override
	protected List getFieldOrder() {
		// TODO Auto-generated method stub
		return Arrays.asList("byRuleID","byEnable","byRes1","szRuleName","byRuleCalibType","byRes2","struPointTherm","struRegionTherm","byRes");
	}
}
...
public static class NET_SDK_POINT_THERMOMETRY extends Structure {
	...
	@Override
	protected List getFieldOrder() {
		return Arrays.asList("fPointTemperature","struPoint","byRes");
	}
}
...
public static class NET_SDK_REGION_THERMOMETRY extends Structure {
	...
	@Override
	protected List getFieldOrder() {
		return Arrays.asList("fMaxTemperature","fMinTemperature","fAverageTemperature","fTemperatureDiff","struRegion","byRes");
	}
}
...
public static class NET_DVR_LINEPOLYGON_THERM_CFG extends Structure{
	public float fMaxTemperature;//最高温度
	public float fMinTemperature;//最低温度
	public float fAverageTemperature;//平均温度
	public float fTemperatureDiff;//温差
	public NET_VCA_POLYGON struRegion;//区域坐标（当规则标定类型为框/线的时候生效）
	public byte[] byRes = new byte[32];
	@Override
	protected List getFieldOrder() {
		return Arrays.asList("fMaxTemperature","fMinTemperature","fAverageTemperature","fTemperatureDiff","struRegion","byRes");
...
public static class NET_VCA_POLYGON extends Structure{
	public short dwPointNum;//有效点（大于等于3），若是3点在一条线上认为是无效区域，线交叉认为是无效区域
	public NET_VCA_POINT[] struPos = new NET_VCA_POINT[10];//多边形边界点，最大值为10
	@Override
	protected List getFieldOrder() {
...
public static class NET_DVR_STD_ABILITY extends Structure{
    ...
    public int     dwCondSize;//[in]条件参数缓冲区大小
    public Pointer lpOutBuffer;//[out]输出参数缓冲区(XML格式)，不为NULL
    public int     dwOutSize;//[in]输出缓冲区大小
    public Pointer lpStatusBuffer;//[out]获取失败返回的状态参数(XML格式：ResponseStatus)，获取成功时不会赋值，如果不需要，可以置NULL
    public int     dwStatusSize;//[in]状态缓冲区大小
    public int     dwRetSize;//[out]获取到的数据长度(如果获取成功，该值为lpOutBuffer的长度；如果获取失败，该值为lpStatusBuffer的长度)
    public byte[]  byRes = new byte[32];

    @Override
    protected List getFieldOrder() {
        return Arrays.asList("lpCondBuffer","dwCondSize","lpOutBuffer","dwOutSize","lpStatusBuffer","dwStatusSize",
                "dwRetSize","byRes");
    }
}
    //配置输入输出参数结构体
    public static class NET_DVR_STD_CONFIG extends Structure{
        public Pointer lpCondBuffer;//[in]条件参数(结构体或者XML格式)，例如通道号等，可以为NULL
        public int     dwCondSize;//[in]条件参数缓冲区大小
        public Pointer lpInBuffer;//[in]输入参数(结构体格式)，获取时为NULL，设置时不为NULL
        public int     dwInSize;//[in]输入参数缓冲区大小
        public Pointer lpOutBuffer;//[out]输出参数(结构体格式)，获取时不为NULL，设置时为NULL

        public int     dwOutSize;//[in]输出参数缓冲区大小
        public Pointer lpStatusBuffer;//[out]返回的状态参数(XML格式：ResponseStatus)，获取和设置成功时不会赋值，如果不需要，可以置NULL
        public int     dwStatusSize;//[in]状态参数缓冲区大小
        public Pointer lpXmlBuffer;//[in/out]byDataType = 1时有效，xml格式数据内容
        public int     dwXmlSize;//[in/out]lpXmlBuffer指向的内存大小：获取时同时作为输入和输出参数，获取成功后会修改返回实际长度；设置时表示实际数据长度【strlen((char*) lpXmlBuffer)】，而不是整个内存大小

        public byte    byDataType;//[in]输入/输出参数类型：0- 使用结构体类型lpInBuffer/lpOutBuffer有效，1- 使用XML类型lpXmlBuffer有效
        public byte[]  byRes = new byte[23];//[in]保留字节，置为0


        @Override
        protected List getFieldOrder() {
            return Arrays.asList("lpCondBuffer","dwCondSize","lpInBuffer","dwInSize","lpOutBuffer",
                    "dwOutSize","lpStatusBuffer","dwStatusSize","lpXmlBuffer","dwXmlSize",
                    "byDataType","byRes");
        }
    }

    //
    public static class NET_DVR_COND_INT extends Structure{
        public int dword;
        @Override
        protected List getFieldOrder() {
            return Arrays.asList("dword");
        }
    }
    ...
    public static class BYTE_ARRAY extends SdkStructure{
        ...
        public BYTE_ARRAY(int iLen,String str) {
            byValue = new byte[iLen];
            System.arraycopy(str.getBytes(), 0, byValue, 0, str.length());
        }
    }
    ...
    public static class NET_DVR_XML_CONFIG_INPUT extends SdkStructure{
        ...
        public Pointer lpInBuffer;//输入参数缓冲区，XML格式
    ...
    /*public static class NET_DVR_MIME_UNIT extends SdkStructure{
        public char[] szContentType = new char[32]; //对应ISAPI协议中的Content-Type字段，内容格式须符合HTTP协议，如text/json，text/xml等
        public char[] szName = new char[MAX_FILE_PATH_LEN]; //对应HTTP协议中name字段 例：name="upload"，则赋值"upload"
        public char[] szFilename = new char[MAX_FILE_PATH_LEN]; //对应HTTP协议中filename字段 例：filename="C:\Users\test\Desktop\11.txt"，则赋值"C:\Users\test\Desktop\11.txt"
        int    dwContentLen; //Content的长度
        String pContent; //数据指针，对应ISAPI协议的XML/JSON报文
        byte[]  byRes =new byte[16];
    }*/
...
public static interface FMSGCallBack_Linux extends Callback {
    public void invoke(NativeLong lCommand, NET_DVR_ALARMER pAlarmer, RECV_ALARM  pAlarmInfo, int dwBufLen,Pointer pUser);
}

public static interface FRemoteConfigCallback extends StdCallCallback {
    public void invoke(int dwType, NET_DVR_THERMOMETRY_UPLOAD lpBuffer, int dwBufLen,Pointer pUserData);
}

public static interface FRemoteConfigCallback_Linux extends Callback {
    public void invoke(int dwType, NET_DVR_THERMOMETRY_UPLOAD lpBuffer, int dwBufLen,Pointer pUserData);
}

public static interface FRemoteConfigCallback2 extends StdCallCallback {
    public void invoke(int dwType, NET_SDK_MANUAL_THERMOMETRY  lpBuffer, int dwBufLen,Pointer pUserData);
}
   ...
   public static interface FMessageCallBack extends Callback {
	...
	/*
	 * public static interface FDrawFun extends Callback { public void
	 * invoke(NativeLong lRealHandle,HDC hDc,int dwUser); }
	 */
...
//NET_DVR_SetDVRMessage的扩展
 ...
 boolean  NET_DVR_SetDVRMessageCallBack_V30(FMSGCallBack_Linux fMessageCallBack, Pointer pUser);
...
//参数配置 begin
 ...
 boolean  NET_DVR_GetSTDConfig(NativeLong lUserID,int dwCommand,NET_DVR_THERMOMETRY_BASICPARAM  lpConfigParam);
 boolean  NET_DVR_SetSTDConfig(NativeLong lUserID,int dwCommand,NET_DVR_STD_CONFIG lpConfigParam);
 boolean  NET_DVR_GetSTDConfig(NativeLong lUserID,int dwCommand,NET_DVR_STD_CONFIG lpConfigParam);
 //获取设备能力集
 boolean  NET_DVR_GetSTDAbility(NativeLong lUserID,int dwAbilityType,NET_DVR_STD_ABILITY  lpAbilityParam);
...
//前面板锁定
 ...
 //启动远程配置
 NativeLong NET_DVR_StartRemoteConfig(NativeLong lUserID, int dwCommand,NET_DVR_REALTIME_THERMOMETRY_COND lpInBuffer,int dwInBufferLen,FRemoteConfigCallback  cbStateCallback,Pointer pUserData);
 NativeLong NET_DVR_StartRemoteConfig(NativeLong lUserID, int dwCommand,NET_DVR_REALTIME_THERMOMETRY_COND lpInBuffer,int dwInBufferLen,FRemoteConfigCallback_Linux  cbStateCallback,Pointer pUserData);
 NativeLong NET_DVR_StartRemoteConfig(NativeLong lUserID, int dwCommand,NET_DVR_REALTIME_THERMOMETRY_COND lpInBuffer,int dwInBufferLen,FRemoteConfigCallback2  cbStateCallback,Pointer pUserData);

    NativeLong NET_DVR_StartRemoteConfig(NativeLong lUserID, int dwCommand,Pointer lpInBuffer,int dwInBufferLen,CardCfgCondCallback  cbStateCallback,Pointer pUserData);
...
public static interface CardCfgCondCallback extends StdCallCallback {
 ...
 boolean NET_DVR_SendRemoteConfig(NativeLong lHandle,int dwDataType,Pointer pSendBuf,int dwBufSize);
    ...
    boolean  NET_DVR_STDXMLConfig(NativeLong lUserID,NET_DVR_XML_CONFIG_INPUT input,NET_DVR_XML_CONFIG_OUTPUT output);
