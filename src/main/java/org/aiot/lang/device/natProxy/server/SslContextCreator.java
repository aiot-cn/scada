...
public class SslContextCreator {
    ...
    public SSLContext initSSLContext() {
        final String jksPath = ProxyConfig.serverSslJksPath;
        ...
        // keyManagerPassword
        // has to be defined
        final String keyStorePassword = ProxyConfig.serverSslKeyStorePassword;
        final String keyManagerPassword = ProxyConfig.serverSslKeyManagerPassword;
        ...
        boolean needsClientAuth = ProxyConfig.serverSslNeedsClientAuth;
