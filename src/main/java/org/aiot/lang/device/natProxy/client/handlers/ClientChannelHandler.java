package org.aiot.lang.device.natProxy.client.handlers;

import io.netty.bootstrap.Bootstrap;
import io.netty.buffer.ByteBuf;
import io.netty.buffer.Unpooled;
import io.netty.channel.*;
import org.aiot.lang.device.natProxy.client.ClientChannelMannager;
...
import org.aiot.lang.device.natProxy.client.listener.ProxyChannelBorrowListener;
import org.aiot.lang.device.natProxy.protocol.Constants;
                ...
                if (future.isSuccess()) {
                    ...
                    ClientChannelMannager.borrowProxyChanel(proxyBootstrap, new ProxyChannelBorrowListener() {
                        ...
                        public void success(Channel channel) {
                            ...
                            proxyMessage.setUri(userId + "@" + ClinicConfig.clientKey);
