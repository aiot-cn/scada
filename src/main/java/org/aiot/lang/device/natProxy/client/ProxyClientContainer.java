package org.aiot.lang.device.natProxy.client;
...
import org.aiot.lang.device.natProxy.client.handlers.ClientChannelHandler;
import org.aiot.lang.device.natProxy.client.handlers.RealServerChannelHandler;
import org.aiot.lang.device.natProxy.client.listener.ChannelStatusListener;
import org.aiot.lang.device.natProxy.common.container.Container;
import org.aiot.lang.device.natProxy.common.container.ContainerHelper;
import org.aiot.lang.device.natProxy.protocol.IdleCheckHandler;
import org.aiot.lang.device.natProxy.protocol.ProxyMessage;
import org.aiot.lang.device.natProxy.protocol.ProxyMessageDecoder;
import org.aiot.lang.device.natProxy.protocol.ProxyMessageEncoder;
...
public class ProxyClientContainer implements Container, ChannelStatusListener {
    ...
    private void connectProxyServer() {
        ...
        bootstrap.connect(ClinicConfig.serverHost, ClinicConfig.serverPort).addListener(new ChannelFutureListener() {
            ...
            public void operationComplete(ChannelFuture future) throws Exception {
                if (future.isSuccess()) {
                    ...
                    proxyMessage.setUri(ClinicConfig.clientKey);
